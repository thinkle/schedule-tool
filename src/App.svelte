...
<div class="modal" class:show={about} on:click={() => (about = false)}>
  <div class="about">
    ...
    <p>
      Just copy the URL (Control-L, Control-C) to share your schedule idea width
      someone.
    </p>
    <p>
      ...
      instructions. If I failed on that front, let me know and I'll try to make
      improvements. Generally, you can click on things and edit them :)
    </p>
  </div>
</div>
